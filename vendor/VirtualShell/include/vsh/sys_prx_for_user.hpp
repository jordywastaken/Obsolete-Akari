...
namespace sysPrxForUser
{
    ...
    static sys_prx_id_t _sys_prx_get_module_id_by_address(void* addr) { return sysPrxForUser_0341BB97(addr); }
    ...
    static void* _sys_mempool_try_allocate_block(sys_mempool_t mempool) { return sysPrxForUser_05C65656(mempool); }
    ...
    int sysPrxForUser_06574237(char *str, size_t size, const char *fmt, ...); // _sys_snprintf()
    ...
    static int _sys_lwmutex_lock(sys_lwmutex_t* lwmutex, usecond_t timeout) { return sysPrxForUser_1573DC3F(lwmutex, timeout); }
    ...
    static int _sys_lwmutex_unlock(sys_lwmutex_t* lwmutex) { return sysPrxForUser_1BC200F4(lwmutex); }

    int sysPrxForUser_1C9A942C(sys_lwcond_t *lwcond);
    static int _sys_lwcond_destroy(sys_lwcond_t* lwcond) { return sysPrxForUser_1C9A942C(lwcond); }
    ...
    static int _sys_ppu_thread_create(sys_ppu_thread_t* thread_id, void(*entry)(uint64_t), uint64_t arg, int prio, size_t stacksize, uint64_t flags, const char* threadname) { return sysPrxForUser_24A1EA07(thread_id, entry, arg, prio, stacksize, flags, threadname); }

    // sysPrxForUser_25062C8E  // ?

    uint64_t sysPrxForUser_25596F51(sys_mempool_t mempool);
    static uint64_t _sys_mempool_get_count(sys_mempool_t mempool) { return sysPrxForUser_25596F51(mempool); }
    ...
    static int _sys_lwcond_wait(sys_lwcond_t *lwcond, usecond_t timeout) { return sysPrxForUser_2A6D9D51(lwcond, timeout); }
    ...
    static int _sys_lwmutex_create(sys_lwmutex_t* lwmutex, sys_lwmutex_attribute_t* attr) { return sysPrxForUser_2F85C0EF(lwmutex, attr); }
    ...
    static int _sys_ppu_thread_get_id(sys_ppu_thread_t* thread_id) { return sysPrxForUser_350D454E(thread_id); }
    ...
    static void *_sys_memchr(void *ptr, int value, size_t num){ return sysPrxForUser_3BD53C7B(ptr, value, num); }
    ...
    static int _sys_mmapper_free_memory(sys_memory_t mem_id) { return sysPrxForUser_409AD939(mem_id); }

    // sysPrxForUser_4232B0DB  // ?

    int sysPrxForUser_42B23552(void* library);
    static int _sys_prx_register_library(void* library) { return sysPrxForUser_42B23552(library); }
    ...
    static int _sys_mmapper_unmap_memory(sys_addr_t start_addr, sys_memory_t *mem_id) { return sysPrxForUser_4643BA6E(start_addr, mem_id); }

    int sysPrxForUser_4A071D98(sys_interrupt_thread_handle_t ih);
    static int _sys_interrupt_thread_disestablish(sys_interrupt_thread_handle_t ih) { return sysPrxForUser_4A071D98(ih); }
    ...
    static int _sys_process_is_stack(const void *p) { return sysPrxForUser_4F7172C9(p); }

    void sysPrxForUser_5267CB35(int *lock);
    static void _sys_spinlock_unlock(int *lock) { sysPrxForUser_5267CB35(lock); }

    int sysPrxForUser_52AADADF(sys_lwcond_t *lwcond, sys_ppu_thread_t ppu_thread_id);
    static int _sys_lwcond_signal_to(sys_lwcond_t *lwcond, sys_ppu_thread_t ppu_thread_id) { return sysPrxForUser_52AADADF(lwcond, ppu_thread_id); }
    ...
    static int _sys_mempool_free_block(sys_mempool_t mempool, void *block) { return sysPrxForUser_608212FC(mempool, block); }
    ...
    static int _sys_mmapper_allocate_memory_from_container(size_t size, sys_memory_container_t container, uint64_t flags, sys_memory_t *mem_id) { return sysPrxForUser_70258515(size, container, flags, mem_id); }

    int sysPrxForUser_71A8472A(void* addr, uint64_t size);
    static int _sys_get_random_number(void* addr, uint64_t size) { return sysPrxForUser_71A8472A(addr, size); }

    int sysPrxForUser_722A0254(int *lock);
    static int _sys_spinlock_trylock(int *lock) { return sysPrxForUser_722A0254(lock); }

    // sysPrxForUser_728FD7C3  // ?

    sys_prx_id_t sysPrxForUser_74311398(void);
    static sys_prx_id_t _sys_prx_get_my_module_id() { return sysPrxForUser_74311398(); }

    // sysPrxForUser_744680A2  // sys_initialize_tls

    char *sysPrxForUser_7498887B(char *str, int c);
    static char *_sys_strchr(char *str, int c) { return sysPrxForUser_7498887B(str, c); }

    // sysPrxForUser_750DD5CD  // ?

    int sysPrxForUser_791B9219(char *str, const char *format, va_list arg);
    static int _sys_vsprintf(char *str, const char *format, va_list arg) { return sysPrxForUser_791B9219(str, format, arg); }
    ...
    static int _sys_prx_stop_module(sys_prx_id_t id, size_t args, void* argp, int* modres, sys_prx_flags_t flags, sys_prx_stop_module_option_t* pOpt) { return sysPrxForUser_80FB0C19(id, args, argp, modres, flags, pOpt); }

    system_time_t sysPrxForUser_8461E528(void);
    static system_time_t _sys_time_get_system_time() { return sysPrxForUser_8461E528(); }

    int sysPrxForUser_84BB6774(sys_prx_id_t id, sys_prx_flags_t flags, sys_prx_module_info_t *pInfo);
    static int _sys_prx_get_module_info(sys_prx_id_t id, sys_prx_flags_t flags, sys_prx_module_info_t* pInfo) { return sysPrxForUser_84BB6774(id, flags, pInfo); }
    ...
    static int _sys_raw_spu_load(sys_raw_spu_t id, const char *path, uint32_t *entry) { return sysPrxForUser_893305FA(id, path, entry); }
    ...
    static void _sys_spinlock_initialize(int *lock) { sysPrxForUser_8C2BB498(lock); }
    ...
    static char *_sys_strncat(char *dest, const char *src, size_t n) { return sysPrxForUser_996F7CF8(dest, src, n); }

    char *sysPrxForUser_99C88692(char *dest, const char *src);
    static char *_sys_strcpy(char *dest, const char *src) { return sysPrxForUser_99C88692(dest, src); }
    ...
    static void _sys_mempool_destroy(sys_mempool_t mempool) { sysPrxForUser_9D3C0F81(mempool); }

    // sysPrxForUser_9E0623B5  // sys_game_watchdog_start

    int sysPrxForUser_9F04F7AF(const char *fmt, ...);                  // _sys_printf()
    ...
    static int _sys_prx_start_module(sys_prx_id_t id, size_t args, void* argp, int* modres, sys_prx_flags_t flags, sys_prx_start_module_option_t* pOpt) { return sysPrxForUser_9F18429D(id, args, argp, modres, flags, pOpt); }

    // sysPrxForUser_9F950780  // sys_game_get_rtc_status
    // sysPrxForUser_9FB6228E  // ?

    void *sysPrxForUser_A146A143(sys_mempool_t mempool);
    static void *_sys_mempool_allocate_block(sys_mempool_t mempool) { return sysPrxForUser_A146A143(mempool); }

    int sysPrxForUser_A1F9EAFE(char *str, const char *fmt, ...); // _sys_sprintf()

    void sysPrxForUser_A285139D(int *lock);
    static void _sys_spinlock_lock(int *lock) { sysPrxForUser_A285139D(lock); }
    ...
    static sys_prx_id_t _sys_prx_load_module_on_memcontainer_by_fd(int fd, off64_t offset, sys_memory_container_t mem_container, sys_prx_flags_t flags, sys_prx_load_module_option_t* pOpt) { return sysPrxForUser_A330AD84(fd, offset, mem_container, flags, pOpt); }

    void sysPrxForUser_A3E3BE68(int *once_ctrl, void(*init)(void));
    static void _sys_ppu_thread_once(int *once_ctrl, void(*init)(void)) { sysPrxForUser_A3E3BE68(once_ctrl, init); }

    int sysPrxForUser_A5D06BF0(sys_prx_flags_t flags, sys_prx_get_module_list_t *pInfo);
    static int _sys_prx_get_module_list(sys_prx_flags_t flags, sys_prx_get_module_list_t* pInfo) { return sysPrxForUser_A5D06BF0(flags, pInfo); }
    ...
    static int _sys_lwmutex_trylock(sys_lwmutex_t *lwmutex) { return sysPrxForUser_AEB78725(lwmutex); }
    ...
    static int _sys_mmapper_allocate_memory(uint64_t size, uint64_t flags, sys_memory_t* mem_id) { return sysPrxForUser_B257540B(size, flags, mem_id); }
    ...
    static int _sys_raw_spu_image_load(sys_raw_spu_t id, sys_spu_image_t *img) { return sysPrxForUser_B995662E(id, img); }
    ...
    static int _sys_lwmutex_destroy(sys_lwmutex_t* lwmutex) { return sysPrxForUser_C3476D0C(lwmutex); }

    void sysPrxForUser_C4FD6121(void *base, size_t num, size_t size, int(*compar)(const void*, const void*));
    static void _sys_qsort(void *base, size_t num, size_t size, int(*compar)(const void*, const void*)) { sysPrxForUser_C4FD6121(base, num, size, compar); }
    ...
    static int _sys_mempool_create(sys_mempool_t *mempool, void *chunk, const uint64_t chunk_size, const uint64_t block_size, const uint64_t ralignment) { return sysPrxForUser_CA9A60BF(mempool, chunk, chunk_size, block_size, ralignment); }

    int sysPrxForUser_D0EA47A7(void* library);
    static int _sys_prx_unregister_library(void* library) { return sysPrxForUser_D0EA47A7(library); }
    ...
    static char *_sys_strncpy(char *dest, const char *src, size_t num) { return sysPrxForUser_D3039D4D(dest, src, num); }
    ...
    static int _sys_lwcond_create(sys_lwcond_t *lwcond, sys_lwmutex_t *lwmutex, sys_lwcond_attribute_t *attr) { return sysPrxForUser_DA0EB71A(lwcond, lwmutex, attr); }
    ...
    static int _sys_mmapper_map_memory(sys_addr_t start_addr, sys_memory_t mem_id, uint64_t flags) { return sysPrxForUser_DC578057(start_addr, mem_id, flags); }
    ...
    static sys_prx_id_t _sys_prx_get_module_id_by_name(const char* name, sys_prx_flags_t flags, sys_prx_get_module_id_by_name_option_t* pOpt) { return sysPrxForUser_E0998DBF(name, flags, pOpt); }

    int sysPrxForUser_E0DA8EFD(sys_spu_image_t *img);
    static int _sys_spu_image_close(sys_spu_image_t *img) { return sysPrxForUser_E0DA8EFD(img); }

    // sysPrxForUser_E66BAC36  // console_putc

    void sysPrxForUser_E6F2C1E7(int status);
    static void _sys_process_exit(int status) { return sysPrxForUser_E6F2C1E7(status); }
    ...
    static int _sys_lwcond_signal_all(sys_lwcond_t *lwcond){ return sysPrxForUser_E9A1BD84(lwcond); }

    int sysPrxForUser_EBE5F72F(sys_spu_image_t *img, const void *src, uint32_t type);
    static int _sys_spu_image_import(sys_spu_image_t *img, const void *src, uint32_t type) { return sysPrxForUser_EBE5F72F(img, src, type); }

    // sysPrxForUser_EDEA5F4A  // ?

    int sysPrxForUser_EEF75113(int c);
    static int _sys_toupper(int c) { return sysPrxForUser_EEF75113(c); }

    sys_prx_id_t sysPrxForUser_EF68C17C(int fd, off64_t offset, sys_prx_flags_t flags, sys_prx_load_module_option_t *pOpt);
    static sys_prx_id_t _sys_prx_load_module_by_fd(int fd, off64_t offset, sys_prx_flags_t flags, sys_prx_load_module_option_t* pOpt) { return sysPrxForUser_EF68C17C(fd, offset, flags, pOpt); }

    int sysPrxForUser_EF87A695(sys_lwcond_t *lwcond);
    static int _sys_lwcond_signal(sys_lwcond_t *lwcond) { return sysPrxForUser_EF87A695(lwcond); }

    int sysPrxForUser_F0AECE0D(sys_prx_id_t id, sys_prx_flags_t flags, sys_prx_unload_module_option_t *pOpt);
    static int _sys_prx_unload_module(sys_prx_id_t id, sys_prx_flags_t flags, sys_prx_unload_module_option_t* pOpt) { return sysPrxForUser_F0AECE0D(id, flags, pOpt); }
    ...
    static int _sys_vprintf(const char *format, va_list arg) { return sysPrxForUser_FA7F693D(format, arg); }

    int sysPrxForUser_FB5DB080(const void *ptr1, const void *ptr2, size_t num);
    static int _sys_memcmp(const void *ptr1, const void *ptr2, size_t num) { return sysPrxForUser_FB5DB080(ptr1, ptr2, num); }
